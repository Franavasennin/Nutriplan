...
export const MobileNav: React.FC<MobileNavProps> = ({ currentStep, onNavigate, hasPlan }) => (
  <div className="lg:hidden fixed bottom-0 left-0 w-full bg-surface-light dark:bg-surface-dark border-t-2 border-primary/20 p-2 flex justify-around items-center z-50 no-print print:hidden print:static print:invisible">
